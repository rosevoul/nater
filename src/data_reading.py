...
class DataReader(object):
    ...
    def __init__(self, path):
        self.path = path
        self.test_blocks_names, self.test_blocks_descriptions, self.test_blocks_parameters = self.read_test_blocks()
    ...
    def read_test_blocks(self):
        ...
        return (test_blocks_names, test_blocks_descriptions, test_blocks_parameters)
